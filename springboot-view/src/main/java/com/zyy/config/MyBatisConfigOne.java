 ...
 */
@Configuration
@MapperScan(basePackages = "com.zyy.mapper", sqlSessionFactoryRef = "sqlSessionFactoryBean1")
public class MyBatisConfigOne {
     ...
     */
    @Bean
    public DataSourceTransactionManager transactionManagerOne() throws Exception {
